        ...
        database.ref('menu/' + this.props.id).on('value', (data) => {
            ...
            data.forEach(item => {
                ...
                if (itemData.deleted !== true) {
                    items.push({ item: itemData.name, price: itemData.price, extra: { id: item.key, unavailable: itemData.unavailable === true ? true : false } });
                }
            });
            self.setState({
                items: items
            ...
            <div className="Order">
                    ...
                    <CardText>
                        ...
                        >
                            ...
                            <TableHeader numeric name="price" cellFormatter={(price) => `${(price / 100).toFixed(2)}`}>
                                Price</TableHeader>
                            <TableHeader name="extra" cellFormatter={(extra) => 
                                <Button raised colored ripple disabled={extra.unavailable} onClick={this.addItem.bind(this, extra.id)}>Order</Button>
                            }>
                                Order</TableHeader>
                        </DataTable>
                    </CardText>
                ...
                <Card shadow={0} style={{width: '100%'}}>
                    ...
                    <CardText>
                        ...
                        <h6>Total: £<span>{this.calculateTotal()}</span></h6>
                    </CardText>
                    <CardActions border>
